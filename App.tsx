...
const App = () => {
    ...
    // ⚡ Bolt: Wrapped in useCallback to provide stable reference for child components like HacksSection
    ...
    // ⚡ Bolt: Wrapped in useCallback to provide stable reference
    ...
    // ⚡ Bolt: Created stable callbacks for HacksSection props
    const handleHackActivateClick = useCallback((id: number) => {
        showModal('activation', HACKS_DATA.find(h => h.id === id));
    }, [showModal]);

    const handleHackAmplifyClick = useCallback((id: number) => {
        ...
        <div className="bg-black min-h-screen font-sans selection:bg-yellow-400 selection:text-black" onClick={startAudioContext}>
            ...
            >
                ...
                <HacksSection 
                    hacks={HACKS_DATA} 
                    completedHacks={completedHacks} 
                    onActivateClick={handleHackActivateClick}
                    onAmplifyClick={handleHackAmplifyClick}
