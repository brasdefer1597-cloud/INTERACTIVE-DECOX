...
// ⚡ Bolt: Added React.memo and stable callbacks to prevent unnecessary re-renders of list items
const HackCard = memo(({
    hack,
    isCompleted,
    onActivate,
...
// ⚡ Bolt: Wrapped HacksSection with memo to optimize rendering
const HacksSection: React.FC<HacksSectionProps> = memo(({ hacks, completedHacks, onActivateClick, onAmplifyClick, playUIClick }) => {
    ...
    // ⚡ Bolt: Created stable callbacks for HackCard to prevent unnecessary re-renders
